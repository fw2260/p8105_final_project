...
In our statistical analyses, it is confirmed that the critic scores and the number of available platforms per game play big factors in influencing the global revenues of each game. 
