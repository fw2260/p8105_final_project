...
* Recode console names (e.g.recode PS4 as PlayStation 4) for data scrapedfrom VGChartz;

* Get `critic_score` from Metacritic using `left_join` by `title` and `console`;

* Obtain realse year from `release_date` using `separate` function;

* Add a new column: `console_developer`, which indicates the developer of the console;

* Add another new column: `n_platforms`, which shows the number of consoles the game run on.
