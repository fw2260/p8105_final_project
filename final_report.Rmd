...
The left bar graph shows the annual global revenues (in million USD) of video games released between 2001 and 2020 on the three companies' platforms, and the right one shows the number of video games released on these platforms in the same period. 
...
Both annual sales and number of games released from 2008 on decreases over time, possibly reflecting the effects of the 2008 financial recession and the rise in popularity of PC and mobile gaming as technology advances. It may also be the case that console makers are not eager to release new models as often, which also decreases the number of games published each year. Furthermore, annual sales of more recent years may be lower because the games are younger than their predecessors. 
