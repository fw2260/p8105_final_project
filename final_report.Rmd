...
* `console_developer`: The developers of the platforms

* `n_platforms`: Number of platforms that the game is on
...
* `total_sale`: Total worldwide sales (in millions $)

* `na_sale`: Sales in North America (in millions $)

* `pal_sale`: Sales in Europe (in millions $)

* `japan_sale`: Sales in Japan (in millions $)

* `other_sale`: Sales in other regions (in millions $)
