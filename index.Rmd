...
* As the critic scores increase, there is a general positive correlation with the globlal sales.

* A game that releases on multiple platforms has a much higher potential customer number which results in higher sales. 
