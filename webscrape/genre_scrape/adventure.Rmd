---
title: "Scrape game sales - Adventure genre"
...
sale_values = map_df(1:9, read_sales_values)

```


```{r}
write_csv(sale_values, "data/adventure.csv")
```
