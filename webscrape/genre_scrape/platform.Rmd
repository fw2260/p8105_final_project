---
title: "Scrape game sales - Platform genre"
...
sale_values = map_df(1:6, read_sales_values)

```


```{r}
write_csv(sale_values, "data/platform.csv")
```
