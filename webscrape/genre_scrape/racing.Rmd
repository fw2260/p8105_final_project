---
title: "Scrape game sales - Racing genre"
...
sale_values = map_df(1:8, read_sales_values)

```


```{r}
write_csv(sale_values, "data/racing.csv")
```
