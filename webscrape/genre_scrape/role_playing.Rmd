---
title: "Scrape game sales - Role playing genre"
...
sale_values = map_df(1:10, read_sales_values)

```

```{r}
write_csv(sale_values, "data/role_playing.csv")
```
