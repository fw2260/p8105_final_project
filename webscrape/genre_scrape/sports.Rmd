---
title: "Scrape game sales - Sports genre"
...
sale_values = map_df(1:14, read_sales_values)

```

```{r}
write_csv(sale_values, "data/sports.csv")
```
