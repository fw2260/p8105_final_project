---
title: "Scrape game sales - Strategy genre"
...
sale_values = map_df(1:4, read_sales_values)

```

```{r}
write_csv(sale_values, "data/strategy.csv")
```
